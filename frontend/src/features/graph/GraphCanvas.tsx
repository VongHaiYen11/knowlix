  ...
  return (
    <div className="flex h-screen min-h-0 flex-col">
      ...
      <div className="relative min-h-0 flex-1 overflow-hidden bg-secondary/30">
        <div className="absolute right-4 top-4 z-10 inline-flex rounded-xl border border-border bg-card/90 p-1 backdrop-blur-sm elevated">
